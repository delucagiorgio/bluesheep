...
public class StarVegasInputRecord extends AbstractScrapingInputRecord implements IKeyEventoComparator {
	...
	public StarVegasInputRecord(Date dataOraEvento, Sport sport, String campionato, String partecipante1, String partecipante2, String filler) {
		super(dataOraEvento, sport, campionato, partecipante1, partecipante2, filler);
		this.source = Service.STARVEGAS_SERVICENAME;
		this.liquidita = -1D;
		this.bookmakerName = "Starvegas";
	}

	public StarVegasInputRecord(AbstractInputRecord starVegasRecord) {
		super(starVegasRecord);
		this.source = Service.STARVEGAS_SERVICENAME;
		this.liquidita = -1D;
		this.bookmakerName = "Starvegas";
	}
