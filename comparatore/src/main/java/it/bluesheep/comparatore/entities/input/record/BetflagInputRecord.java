...
public class BetflagInputRecord extends AbstractScrapingInputRecord implements IKeyEventoComparator{

	private static Logger logger = Logger.getLogger(BetflagInputRecord.class);
	
	public BetflagInputRecord(Date dataOraEvento, Sport sport, String campionato, String partecipante1, String partecipante2, String filler) {
		super(dataOraEvento, sport, campionato, partecipante1, partecipante2, filler);
		this.source = Service.BETFLAG_SERVICENAME;
		this.bookmakerName = BlueSheepConstants.BETFLAG_EXCHANGE_BOOKMAKER_NAME;
	}

	public BetflagInputRecord(AbstractInputRecord betflagRecord) {
		super(betflagRecord);
		this.source = Service.BETFLAG_SERVICENAME;
		this.bookmakerName = BlueSheepConstants.BETFLAG_EXCHANGE_BOOKMAKER_NAME;
	}
