...
public class AbstractScrapingInputRecord extends AbstractInputRecord implements IKeyEventoComparator {

	protected static Logger logger;
	
	protected  AbstractScrapingInputRecord(Date dataOraEvento, Sport sport, String campionato, String partecipante1, String partecipante2, String filler) {
		super(dataOraEvento, sport, campionato, partecipante1, partecipante2, filler);
	}
	
	protected  AbstractScrapingInputRecord(AbstractInputRecord record) {
		super(record);
	}
