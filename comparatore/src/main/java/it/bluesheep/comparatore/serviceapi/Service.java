...
public enum Service {
	...
	BETFAIR_EX_SERVICENAME("BETFAIR"),
	BETFAIR_SB_SERVICENAME("BETFAIR_SB"),
	...
	STANLEYBET_SERVICENAME("STANLEYBET");
	...
	public static boolean isScrapingService(Service serviceName) {
		return Arrays.asList(STARVEGAS_SERVICENAME, GOLDBET_SERVICENAME, PINTERBET_SERVICENAME, BETFLAG_SERVICENAME, STANLEYBET_SERVICENAME).contains(serviceName);
	}
