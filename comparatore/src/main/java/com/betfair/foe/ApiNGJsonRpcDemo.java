...
//            }
            ...
            String marketCatalogueResult = jsonOperations.listMarketCatalogue(marketFilter, marketProjection, MarketSort.FIRST_TO_START, maxResults,
...
//            marketIds.add(marketIdChosen);
            ...
            String marketBookReturn = jsonOperations.listMarketBook(marketIds, priceProjection,
