package com.betfair.enums.dao;

import java.util.HashSet;
import java.util.Set;

import com.betfair.enums.types.MarketBettingType;
...
public class MarketBettingTypeEnumDao {
	...
	public static Set<String> getRelatedMarketBettingTypeByBetType(String betCode){
		Set<String> returnStringList = new HashSet<String>();
		for(MarketBettingType mbt : MarketBettingType.values()) {
			if(mbt.getCode().equals(betCode)) {
				returnStringList.add(betCode);
				break;
			}
		}
